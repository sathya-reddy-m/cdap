...
public class AcceleratorManagerTest extends AppFabricTestBase {
  ...
  public void testGetAppsWithAccelerator() throws Exception {
    ...
    for (String accelerator : declaredAnnotation.accelerators()) {
      AcceleratorManager.AcceleratorApplications appsForAccelerator = acceleratorManager
  ...
  public void testGetAppsForAcceleratorPagination() throws Exception {
    ...
    AcceleratorManager.AcceleratorApplications appsForAcceleratorNext = acceleratorManager
    ...
    AcceleratorManager.AcceleratorApplications appsForAcceleratorNext1 = acceleratorManager
